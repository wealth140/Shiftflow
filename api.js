...
window.ShiftFlowAPI = (function () {
  ...
  return {
    ...
    getMinistries: function () { return get("/ministries"); },
    createMinistry: function (name) { return post("/ministries", { name: name }); },
    assignMinistryLeader: function (ministryId, userId) { return post("/ministries/" + encodeURIComponent(ministryId) + "/leader", { userId: userId }); },
